...
<a:report
	...
	navUrlPrefix="op=groupReport&op=groupReport&queryname=${model.queryName}&domain=${model.domain}${empty payload.type ? '' : '&type='}${payload.encodedType}"
...
<table class="machines">
	<tr class="left">
		<th>&nbsp;[&nbsp; 
					<a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&type=${payload.encodedType}&queryname=${model.queryName}" >All</a>
		     &nbsp;]&nbsp; 
			<c:forEach var="ip" items="${model.ips}">
   	  		&nbsp;[&nbsp;
					<a href="?domain=${model.domain}&ip=${ip}&date=${model.date}&group=${payload.group}&type=${payload.encodedType}&queryname=${model.queryName}">${ip}</a>
   	 		&nbsp;]&nbsp;
			</c:forEach>
		</th>
	</tr>
...
<table class='table table-hover table-striped table-condensed '>
	<c:choose>
		...
		<c:otherwise>
			...
			<a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&op=groupReport&type=${payload.encodedType}&sort=type&queryname=${model.queryName}"> Name</a></th>
			<th><a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&op=groupReport&type=${payload.encodedType}&sort=total&queryname=${model.queryName}">Total</a></th>
			<th><a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&op=groupReport&type=${payload.encodedType}&sort=failure&queryname=${model.queryName}">Failure</a></th>
			<th><a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&op=groupReport&type=${payload.encodedType}&sort=failurePercent&queryname=${model.queryName}">Failure%</a></th>
			<th>Sample Link</th>
			<th><a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&op=groupReport&type=${payload.encodedType}&sort=total&queryname=${model.queryName}">QPS</a></th>
			<th><a href="?domain=${model.domain}&date=${model.date}&group=${payload.group}&op=groupReport&type=${payload.encodedType}&sort=total&queryname=${model.queryName}">Percent%</a></th>
			</tr>
