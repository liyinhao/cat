...
import com.dianping.cat.report.page.topGroup.transform.DistributionDetailVisitor.DistributionDetail;
...
public class Model extends AbstractReportModel<Action, ReportPage, Context> {
	...
	public List<String> getIps() {
		if (m_report == null) {
			...
			return SortHelper.sortIpAddress(m_report.getBus());
		}
	}
	...
	public void setReport(TopGroupReport report) {
		m_report = report;
	}
